...
import com.yeol.market.point.ui.dto.PointSpendRequest;
...
public class PointController {
    ...
    public ResponseEntity<Void> chargePoint(@RequestBody final PointSpendRequest pointSpendRequest) {
        pointService.spendPoint(pointSpendRequest.toServiceDto());
        return null;
    }
}
